...
public class WiaDeviceManager : NativeWiaObject
{
    ...
    public WiaDevice? PromptForDevice(IntPtr parentWindowHandle = default)
    {
    ...
    public string[]? PromptForImage(WiaDevice device, IntPtr parentWindowHandle = default, string? tempFolder = null)
    {
